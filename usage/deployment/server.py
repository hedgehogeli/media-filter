...
from .models.yolo_clip import load_for_inference, transform_image
    ...
    def _process_batch(self, batch: ClientBatch) -> List[ProcessedImage]:
        ...
        for img_data in batch.images:
            try:
                ...
                processed.append(
                    ProcessedImage(
                        filename=img_data.filename, processed_img=transformed_img
                    )
                )
            except Exception as e:
                ...
                processed.append(
                    ProcessedImage(
                        filename=img_data.filename, error=f"Transform failed: {str(e)}"
                    )
                )
        return processed
...
class ModelInferenceWorker(Thread):
    ...
    def _process_batch(self, batch: ModelBatch) -> Dict[str, BatchResponse]:
        ...
        try:
            ...
            # i really should be model agnostic and just call model(tensor_batch) here
            # and tensor_batch shouldnt necessarily be a tensor
...
if __name__ == "__main__":
    ...
    model_path = "/home/hedge/Workspace/Code/img-classifier/model/checkpoints/resnet_clip_yolo_mean_teacher_20251101_130004/checkpoint_epoch2_step113365_acc0.1185_20251102_103555.pth"
